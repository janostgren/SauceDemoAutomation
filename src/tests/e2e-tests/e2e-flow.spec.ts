...
test.describe.parallel('login tests', () => {
  ...
  test('Complete purchasing the first item with a Standard User', async ({ inventoryPage, cartPage,checkoutStepOne, checkoutStepTwo,checkoutComplete, header, standardUser }) => {
    let counter=0;
    let items: string[] = [];
  ...
  test('Cancel purchasing the first item after adding it to the cart with a Standard User', async ({ inventoryPage, cartPage,checkoutStepOne, checkoutStepTwo,checkoutComplete, header, standardUser }) => {
    let counter=0;
    let items: string[] = [];
